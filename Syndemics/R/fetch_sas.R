...
fetch_sas <- function(){
  ...
  req <- httr::GET("https://api.github.com/repos/SyndemicsLab/PHD/git/trees/main?recursive=1")
  httr::stop_for_status(req)

  file_list <- grep(".sas", unlist(lapply(httr::content(req)$tree, "[", "path"), use.names = FALSE),
